  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50">
      ...
      <main className="max-w-7xl mx-auto px-2 sm:px-3 lg:px-8 py-3 sm:py-4 lg:py-8">
        ...
        {/* Actions */}
        <div className="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-3 gap-2 sm:gap-3 lg:gap-6">
          <Card className="lg:col-span-2 bg-gradient-to-br from-white to-blue-50/50 dark:from-white/5 dark:to-blue-900/10 border-blue-100 dark:border-blue-900/30 shadow-2xl">
            ...
            <CardContent className="pb-3 sm:pb-4 lg:pb-8 px-2 sm:px-3 lg:px-6">
              <Button 
          ...
          <div className="space-y-2 sm:space-y-3 lg:space-y-6">
            <Card className="px-2 sm:px-3 lg:px-6">
              <CardHeader className="pb-1 sm:pb-2 pt-2 sm:pt-3 lg:pt-6">
                <CardTitle className="flex items-center gap-1.5 sm:gap-2 text-xs sm:text-sm">
                  <Upload className="w-2.5 h-2.5 sm:w-3.5 sm:h-3.5 lg:w-5 lg:h-5" />
                  Upload File
                </CardTitle>
                <CardDescription className="text-[9px] sm:text-xs">Upload foto dari galeri HP</CardDescription>
              </CardHeader>
              <CardContent className="pb-2 sm:pb-3 lg:pb-6">
                <Button onClick={() => router.push("/survey/upload")} variant="outline" className="w-full py-2 sm:py-3 lg:py-6 h-7 sm:h-9 lg:h-12 text-[10px] sm:text-xs">
                  Pilih File
                </Button>
              </CardContent>
            </Card>
            ...
            {user.role === "admin" && (
              <Card className="px-2 sm:px-3 lg:px-6">
                <CardHeader className="pt-2 sm:pt-3 lg:pt-6">
                  <CardTitle className="flex items-center gap-1.5 sm:gap-2 text-xs sm:text-sm">
                    <BarChart3 className="w-2.5 h-2.5 sm:w-3.5 sm:h-3.5 lg:w-5 lg:h-5" />
                    Admin Panel
                  </CardTitle>
                  <CardDescription className="text-[9px] sm:text-xs">Lihat semua foto yang telah diupload</CardDescription>
                </CardHeader>
                <CardContent className="pb-2 sm:pb-3 lg:pb-6">
                  <Button onClick={() => router.push("/admin")} className="w-full bg-indigo-600 hover:bg-indigo-700 h-7 sm:h-9 lg:h-12 text-[10px] sm:text-xs">
                    Buka Admin
                  </Button>
                </CardContent>
              </Card>
